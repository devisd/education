import { getAllTraining, getPriceList } from "@/api/services";
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 md:p-8">
                    ...
                    <div className="flex justify-end mt-5">
                        <a href={`${process.env.NEXT_PUBLIC_BASE_URL}${priceList?.document.url}`} className="inline-flex items-center px-4 py-2 border border-primary-600 text-primary-600 bg-white hover:bg-primary-50 rounded-lg font-medium transition-colors">
